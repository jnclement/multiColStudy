...
echo "arguments = ${TAG} \$(Process) ${EVT}" >> $PREFIX/$SUBNAME
...
echo "error = /sphenix/user/jocl/projects/multiColStudy/output/err/error_${BASENAME}_\$(Process).err" >> $PREFIX/$SUBNAME
